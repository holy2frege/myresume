...
\par{\centering{\Huge 박 \textsc{호열}}\bigskip\par} % Your name
\bigskip
...
%----------------------------------------------------------------------------------------
%	SCHOLARSHIPS, PATENTS and  ADDITIONAL INFO
%----------------------------------------------------------------------------------------
\bigskip
...
%% \begin{tabular}{rl}
%% \textsc{English:} & 실력:중 - IBT Toefl(103), gre(1280)\\
%% \textsc{Spanish:} & 실력:하 - Antigua, Guatemala에서 3개월 spanish school에서 공부\\
